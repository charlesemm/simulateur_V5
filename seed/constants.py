...
MEDICAL_ACTS = [
    ...
    ("HOS-MED", "Hospitalisation en médecine générale", "hospitalisation", "HOS", 2500),
    ("HOS-CHI", "Hospitalisation en chirurgie", "hospitalisation", "HOS", 4000),
    ("HOS-MAT", "Hospitalisation en maternité", "hospitalisation", "HOS", 3000),
    ("HOS-PED", "Hospitalisation en pédiatrie", "hospitalisation", "HOS", 2500),
    ("HOS-REA", "Hospitalisation en réanimation", "hospitalisation", "HOS", 4500),
